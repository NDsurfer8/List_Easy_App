...
const styles = StyleSheet.create({
  ...
  loadingLabel: { marginTop: 12, color: colors.textMuted },
  ...
  playPauseText: { color: colors.textOnPrimary, fontWeight: '600', fontSize: 15 },
  timeText: { fontSize: 14, color: colors.textMuted, textAlign: 'center', marginBottom: 8 },
  ...
  stepBtnText: { fontSize: 15, fontWeight: '600', color: colors.textSecondary },
  sliderRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  sliderLabel: { fontSize: 14, color: colors.textSecondary, marginRight: 8 },
  timeInput: {
    borderWidth: 1,
    borderColor: colors.border,
    borderRadius: 8,
  ...
  sliderSuffix: { fontSize: 14, color: colors.textMuted, marginLeft: 4 },
  refreshBtn: { alignSelf: 'center', paddingVertical: 6 },
  refreshBtnText: { color: colors.primaryLight, fontWeight: '600', fontSize: 14 },
  hint: { fontSize: 13, color: colors.textMuted, marginBottom: 8 },
  section: { marginTop: 20 },
  sectionTitle: { fontSize: 16, fontWeight: '600', color: colors.textSecondary, marginBottom: 8 },
  itemRow: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: colors.surface,
  ...
  titleLabel: { fontSize: 14, fontWeight: '600', color: colors.textSecondary, marginTop: 16, marginBottom: 6 },
  titleInput: {
    borderWidth: 1,
    borderColor: colors.border,
    borderRadius: 10,
